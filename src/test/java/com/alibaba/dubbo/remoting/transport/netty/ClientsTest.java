...
import com.alibaba.dubbo.remoting.transport.netty5.Netty5Transporter;
...
public class ClientsTest {
    ...
    public void testGetTransport3() {
        String name = "netty5";
        assertEquals(Netty5Transporter.class, ExtensionLoader.getExtensionLoader(Transporter.class).getExtension(name).getClass());
    }
