...
import com.alibaba.dubbo.remoting.transport.netty5.Netty5Client;
import com.alibaba.dubbo.remoting.transport.netty5.Netty5Server;
...
public class ThreadNameTest {
    ...
    private Netty5Server server;
    private Netty5Client client;
    ...
    public void before() throws Exception {
        ...
        server = new Netty5Server(serverURL, serverHandler);
        client = new Netty5Client(clientURL, clientHandler);
    }
